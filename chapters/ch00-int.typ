...
Dans nos recherches, nous avons appliqué un réseau neuronal convolutionnel sur l’ensemble de données public LUNA16, composé de scanners thoraciques de 888 patients évalués par quatre experts médicaux @Setio2016PulmonaryNetworks.

Finalement, la résultat a montré une performance de classification de nodule. Cela signifie qu’elle peut identifier de manière un peu précise plus de nodules cancéreux et moins de nodules non cancéreux @Lin2016FeatureDetection@Kamnitsas2017EfficientSegmentation.
...
Un changement significatif dans le paradigme de détection des nodules pulmonaires a été l'intégration d'informations contextuelles multi-échelles, en particulier avec l'ensemble de données Luna16. Cette approche tire profit des méthodologies d'apprentissage profond pour évaluer une vaste gamme de caractéristiques morphologiques et structurales à travers diverses échelles@Shen2015@Dou2016Multi-levelDetection. Plusieurs techniques ont démontré leur efficacité.
